...
export const services = [
  {
    ...
    description:
      "Речевая аналитика, ML-скоринг, фрод-мониторинг, AI-агенты — внедрение с глубоким техническим пониманием. От архитектуры до production.",
    details: [
      ...
      "Разработка и внедрение AI-агентов: автономные ассистенты, мульти-агентные системы, автоматизация workflows",
      "Передача знаний команде заказчика",
    ],
    forWho: "Банки, телеком-операторы, госструктуры, FinTech-компании",
    result:
      "Работающая AI-система (включая AI-агентов) в production с обученной командой внутри компании",
  },
  {
    id: 2,
    icon: "Map",
