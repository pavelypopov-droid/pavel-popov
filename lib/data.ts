...
export const services = [
  {
    ...
    details: [
      ...
      "Речевая аналитика (ASR/NLP) для колл-центров и банков",
      "ML-скоринг кредитных рисков и антифрод-системы",
      "Интеграция LLM в бизнес-процессы банков и FinTech",
      "Передача знаний команде заказчика",
    ],
    forWho: "Банки, страховые компании, FinTech-стартапы, телеком",
    result:
  ...
  },
  {
    ...
    forWho: "CIO, CEO и советы директоров банков, финтех-компаний ЦА",
  ...
  },
  {
    ...
    forWho: "Банки, запускающие IT-подразделения; стартапы на growth-стадии",
  ...
  },
  {
    ...
    description:
      "Реализация проектов под ключ: DWH, RegTech, ДБО, интеграции — с созданием базы знаний и передачей команде.",
    details: [
      "Управление проектами DWH/BI от архитектуры до запуска",
      "Внедрение ДБО и мобильного банкинга",
    ...
    forWho: "Банки и финтех, которым нужен результат, а не консультации",
  ...
  },
  {
    ...
    description:
      "Мониторинг законодательства ЦА, адаптация систем под регулятора, сопровождение при проверках.",
    details: [
      "Мониторинг изменений регулирования ЦБ Узбекистана и ЦА",
      "Адаптация IT-систем к новым требованиям регулятора",
      "Автоматизация регуляторной отчётности",
      "Подготовка к проверкам и аудитам",
      "АМЛ/КЯК системы и мониторинг транзакций",
      "Взаимодействие с регулятором по IT-вопросам",
    ],
    forWho:
      "Банки и платёжные системы под регуляторным давлением в Узбекистане и ЦА",
    result: "Полное соответствие требованиям регулятора без штрафов и санкций",
  },
  {
    id: 6,
    icon: "Briefcase",
    ...
    description:
      "Временный технический директор для банка или финтех-стартапа. Принимаю решения — несу ответственность за результат.",
    details: [
      ...
      "Ментoring внутренней IT-команды",
      "Постепенная передача полномочий внутреннему CTO",
    ],
    forWho: "Банки в период смены руководства; стартапы без технического лидера",
    result:
...
export const timeline = [
  ...
  },
  {
    ...
    country: "RU",
    description:
      "Развитие FinTech-практики и DWH/BI-направления в компании с выручкой $100M+.",
  },
  {
    period: "2016–2019",
    ...
    country: "RU",
    description:
      "Развитие продаж банковского ПО (ДБО, АБС, RegTech) для крупнейших банков СНГ.",
  },
  {
    period: "1999–2016",
