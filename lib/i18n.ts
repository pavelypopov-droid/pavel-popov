...
export const translations = {
  ru: {
    ...
    about: {
      ...
      p2: "AI эксперт с практическим опытом: от постановки задачи до production-деплоя. Machine Learning, Speech Analytics, LLM-интеграции, AI-агенты, RAG-архитектуры, on-prem LLM, Voice Biometrics — реализованные проекты, а не теория.",
    ...
    contacts: {
      ...
      or: "Или запишитесь напрямую на удобное время:",
    },
    blog: {
      title: "Блог",
      subtitle: "Практика и аналитика без воды",
  ...
  en: {
    ...
    about: {
      ...
      p2: "AI expert with hands-on experience: from problem definition to production deployment. Machine Learning, Speech Analytics, LLM integrations, AI agents, RAG architectures, on-prem LLM, Voice Biometrics — real projects, not theory.",
    ...
    cta: {
      ...
      subtitle:
        "Free initial consultation — we'll analyze your situation and define how I can help",
      primary: "Book a Consultation",
      secondary: "Write directly →",
    },
    footer: {
      description:
        "International IT & FinTech advisor with 25 years of experience. End-to-end digital transformations for banks and fintech companies in Central Asia.",
      rights: "Pavel Popov",
    ...
    contacts: {
      ...
      subtitle: "Fill the form or write directly — I'll respond within 24 hours",
      form: {
        name: "Name",
        company: "Company",
        email: "Email",
      ...
      or: "Or book a time directly:",
    },
    blog: {
      title: "Blog",
      subtitle: "Practice and analytics without fluff",
