...
const t = {
  ru: {
    eyebrow: "Обо мне",
    title: "25 лет строю цифровое будущее банков",
    ...
    p3: "Работаю как независимый советник и лидер команды. Понимаю рынок ЦА изнутри: регуляторику, культуру, технологический ландшафт.",
    more: "Подробнее обо мне",
    aboutHref: "/about",
  },
  en: {
    eyebrow: "About Me",
    title: "25 years building the digital future of banks",
    ...
    p3: "I work as an independent advisor and team leader. I understand the CA market from the inside: regulation, culture, technology landscape.",
    more: "More about me",
    aboutHref: "/en/about",
  },
};
