...
const t = {
  ru: {
    ...
    p2: "AI эксперт с практическим опытом: от постановки задачи до production-деплоя. Machine Learning, Speech Analytics, LLM-интеграции, AI-агенты, AI-driven development — реализованные проекты, а не теория.",
  ...
  en: {
    ...
    p2: "AI expert with hands-on experience: from problem definition to production deployment. Machine Learning, Speech Analytics, LLM integrations, AI agents — real projects, not theory.",
