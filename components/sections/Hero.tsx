...
const t = {
  ru: {
    ...
    description: "Строю цифровые трансформации под ключ — от стратегии до работающего продукта с передачей знаний.",
    highlight: "25 лет в IT, 150+ проектов, 6 стран ЦА.",
    cta: "Обсудить проект",
    cv: "Скачать CV",
  ...
  en: {
    ...
    description: "Delivering end-to-end digital transformations — from strategy to working product with knowledge transfer.",
    highlight: "25 years in IT, 150+ projects, 6 CA countries.",
    cta: "Discuss Project",
    cv: "Download CV",
