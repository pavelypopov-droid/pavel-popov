...
const t = {
  ru: {
    ...
    description: "Строю цифровые трансформации под ключ — от стратегии до работающего продукта с передачей знаний. Банки, телеком, государственный сектор. Банки, телеком, государственный сектор.",
  ...
  en: {
    ...
    description: "Delivering end-to-end digital transformations — from strategy to working product with knowledge transfer. Banks, telecom, public sector.",
