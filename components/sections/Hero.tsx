...
const t = {
  ru: {
    ...
    name: "Павел Попов",
    title: "IT, AI & Cybersecurity Transformation Leader & Advisor",
    subtitle: "AI · IT · ИБ · Кибербезопасность · FinTech · Enterprise Architecture",
    description: "Провожу цифровую, AI- и ИБ-трансформацию для банков, телекома и госсектора — от стратегии и архитектуры до работающего продукта с передачей знаний команде.",
  ...
  en: {
    ...
    name: "Pavel Popov",
    title: "IT, AI & Cybersecurity Transformation Leader & Advisor",
    subtitle: "AI · IT · InfoSec · Cybersecurity · FinTech · Enterprise Architecture",
    description: "I lead digital, AI and cybersecurity transformations for banks, telecom and government — from strategy and architecture to working product with knowledge transfer.",
