...
const servicesEn = [
  { id: 1, title: "AI Implementation", description: "Speech analytics, ML scoring, fraud monitoring — from architecture to production.", details: ["Audit of existing AI initiatives and prioritisation","ML system architecture: from problem definition to deployment","Speech analytics (ASR/NLP) for call centres and banks","ML credit risk scoring and anti-fraud systems","LLM integration into bank and FinTech processes","Knowledge transfer to the client's team"], forWho: "Banks, insurance companies, FinTech startups, telecom", result: "A working AI system in production with a trained in-house team" },
